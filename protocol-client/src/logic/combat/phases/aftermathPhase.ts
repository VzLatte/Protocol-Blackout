...
import { Player, TurnData, ResolutionLog, ActionType, GridMap, TileType, UnitType, HazardType, DifficultyLevel } from '../../../../src/shared/types';
import { calculateIncome } from '../../../../src/shared/apManager';
