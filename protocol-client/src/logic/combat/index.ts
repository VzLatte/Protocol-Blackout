...
import { Player, TurnData, ResolutionLog, GameMode, DifficultyLevel, HazardType, GridMap } from '../../../src/shared/types';
...
import { resolveItems } from './phases/itemPhase';
...
export function resolveCombat(
  ...
  // PHASE 1.5: Items
  resolveItems(nextPlayers, submissions, logs);
